...
const AP_Param::Info Rover::var_info[] = {
    ...
    // @Param: MODE1
    // @DisplayName: Mode1
    // @Values: 0:Manual,1:Acro,2:New_mode, 3:Steering,4:Hold,5:Loiter,6:Follow,7:Simple,10:Auto,11:RTL,12:SmartRTL,15:Guided
    // @User: Standard
    ...
    // @Values: 0:Manual,1:Acro,2:New_mode, 3:Steering,4:Hold,5:Loiter,6:Follow,7:Simple,10:Auto,11:RTL,12:SmartRTL,15:Guided
    // @User: Standard
    GSCALAR(mode2,           "MODE2",         Mode::Number::NEW_MODE),
